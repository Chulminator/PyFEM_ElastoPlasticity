...
from NN_separate import NeuralNetwork_f
import joblib
import torch
...
class MyPlasticity():
    def __init__(self, Fem):
        ...
        self.f_INPUT_scaler  = joblib.load("/root/Program/PyFEM_ElastoPlasticity/include/PlasticModel/Models/inp_scaler_f.joblib")
        self.f_OUTPUT_scaler = joblib.load("/root/Program/PyFEM_ElastoPlasticity/include/PlasticModel/Models/out_scaler_f.joblib")
        self.model_f = torch.load("/root/Program/PyFEM_ElastoPlasticity/include/PlasticModel/Models/NN_model_f.pth", map_location=torch.device("cpu")).to("cpu")

    def f(self, sig11, sig22, sig33, sig12, sig23, sig31, lamda):

        RT = np.array([sig11, sig22, sig33, sig12, sig23, sig31, lamda]).reshape(1,7)
